...
<head>
    ...
    <title>Prostate Cancer Treatment Doctor in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Seeking a trusted Prostate Cancer Treatment Doctor in India? Consult Dr. Vijay Anand Reddy for expert diagnosis, advanced care, and personalized treatment plans.">
    <!-- Google Fonts -->
...
$faqs = [
    ...
    [
        ...
        'answer' => "With over 34 years of experience in radiation oncology, Dr. Vijay Anand Reddy offers world-class prostate cancer treatment in India. He utilizes cutting-edge technology, personalized treatment plans, and a multidisciplinary approach to ensure the best outcomes for prostate cancer patients. His expertise in IMRT, IGRT, and brachytherapy makes him one of India's leading oncologists."
    ],
    [
                ...
                <div class="container mx-auto px-4">
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <ul class="space-y-4">
                                {[
                                    "Best prostate cancer treatment doctor in India with 34+ years experience",
