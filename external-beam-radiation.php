...
$faqs = [
    ...
    [
        ...
        'answer' => "Dr. Vijay Anand Reddy is recognized as one of the best external beam radiation therapy doctors in India, with over 34 years of experience in medical oncology. His expertise in checkpoint inhibitors, CAR-T cell therapy, and personalized external beam radiation therapy protocols makes him the preferred choice for cancer external beam radiation therapy treatment."
    ],
    [
...
<?php
$whyChoose = [
    "Best external beam radiation therapy doctor in India with 34+ years experience",
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished oncologist with over 34 years of experience in providing world-class cancer care. As the Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced external beam radiation therapy protocols and personalized cancer treatment approaches in India.
                            </p>
