...
<head>
    ...
    <title>Ovarian Cancer Specialist Doctor in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Seeking Ovarian Cancer Specialist Doctor in India? Consult Dr. Vijay Anand Reddy for advanced diagnosis, personalized treatment, and compassionate cancer care.">
    <!-- Google Fonts -->
...
$faqs = [
    ...
    [
        ...
        'answer' => "With over 34 years of experience in radiation oncology, Dr. Vijay Anand Reddy offers world-class ovarian cancer treatment in India. He utilizes cutting-edge technology, personalized treatment plans, and a multidisciplinary approach to ensure the best outcomes for ovarian cancer patients. His expertise in precision radiation therapy and comprehensive cancer care makes him one of India's leading oncologists."
    ],
    [
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                ...
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        <h4 class="font-bold text-medical-dark">Cytoreduction Surgery</h4>
                                        <p class="text-sm text-gray-500">Precision surgical approach with usage of HIPEC if required</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                ...
                <div class="container mx-auto px-4">
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <ul class="space-y-4">
                                {[
                                    "Best ovarian cancer treatment doctor in India with 34+ years experience",
