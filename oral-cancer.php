...
<head>
    ...
    <title>Oral Cancer Treatment in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Seeking Oral Cancer Treatment in India? Consult Dr. Vijay Anand Reddy for expert diagnosis, personalized care & modern treatment options with compassionate support.">
    <!-- Google Fonts -->
...
$faqs = [
    ...
    [
        ...
        'answer' => "With over 34 years of experience in radiation oncology, Dr. Vijay Anand Reddy offers world-class oral cancer treatment in India. He utilizes cutting-edge technology, personalized treatment plans, and a multidisciplinary approach to ensure the best outcomes for oral cancer patients. His expertise in IMRT, IGRT, and organ-preservation therapies makes him one of India's leading oncologists."
    ],
    [
                ...
                <div class="container mx-auto px-4">
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <ul class="space-y-4">
                                {[
                                    "Best oral cancer treatment doctor in India with 34+ years experience",
