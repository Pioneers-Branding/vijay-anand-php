...
<head>
    ...
    <title>Liver Cancer Treatment Doctor in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Seeking Liver Cancer Treatment Doctor in India? Consult Dr. Vijay Anand Reddy for advanced diagnosis, personalized care, and comprehensive liver cancer treatment.">
    <!-- Google Fonts -->
...
$faqs = [
    ...
    [
        ...
        'answer' => "With over 34 years of experience in radiation oncology, Dr. Vijay Anand Reddy offers world-class liver cancer treatment in India. He utilizes cutting-edge technology, personalized treatment plans, and a multidisciplinary approach to ensure the best outcomes for liver cancer patients. His expertise in IMRT, SBRT, and advanced radiation therapies makes him one of India's leading oncologists."
    ],
    [
                ...
                <div class="container mx-auto px-4">
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <ul class="space-y-4">
                                {[
                                    "Best liver cancer treatment doctor in India with 34+ years experience",
