...
<head>
    ...
    <title>Best Surgical Oncology Treatment in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Get expert surgical oncology in India under Dr. Vijay Anand Reddy. Offering advanced tumor resections, minimally invasive surgeries, and comprehensive cancer care.">
    <!-- Google Fonts -->
...
$whyChoose = [
    ...
    "Over 34 years of clinical excellence & 75k+ happy patients",
                ...
                <div class="container mx-auto px-4">
                    ...
                    <div class="grid md:grid-cols-2 gap-12 items-start">
                        ...
                        <div class="relative h-full min-h-[400px]">
                            <img
                                src="assets/services/radiation-vijay.webp"
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished <strong>Surgical Oncologist</strong> with over 34 years of experience. As the Director of Apollo Cancer Centres, Hyderabad, he has been instrumental in establishing the most comprehensive facility for <strong>Surgical Oncology Doctors in India</strong>.
                            </p>
