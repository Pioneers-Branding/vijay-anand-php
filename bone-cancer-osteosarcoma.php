...
<head>
    ...
    <title>Bone Cancer Specialist Doctor in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Seeking a Bone Cancer Specialist Doctor in India? Consult Dr. Vijay Anand Reddy for advanced diagnosis, personalized treatment, and expert care for bone tumors.">
    <!-- Google Fonts -->
...
$faqs = [
    ...
    [
        ...
        'answer' => "With over 34 years of experience in radiation oncology, Dr. Vijay Anand Reddy offers world-class bone cancer treatment in India. He utilizes cutting-edge technology, personalized treatment plans, and a multidisciplinary approach to ensure the best outcomes for bone cancer patients. His expertise in limb-saving therapies makes him one of India's leading oncologists."
    ],
];
?>
<?php
                    ...
                    <div class="mt-12">
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Targeted therapies and immunotherapy for specific bone cancer subtypes, including advanced treatments for metastatic bone cancer.
                                </p>
                            </div>
