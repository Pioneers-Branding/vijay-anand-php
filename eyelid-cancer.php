...
<head>
    ...
    <title>Eyelid Cancer Treatment in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Seeking Eyelid Cancer Treatment in India with expert care. Consult Dr. Vijay Anand Reddy for accurate diagnosis, modern treatment, and personalized oncology care.">
    <!-- Google Fonts -->
...
$faqs = [
    ...
    [
        ...
        'answer' => "With over 34 years of experience in radiation oncology, Dr. Vijay Anand Reddy offers world-class eyelid cancer treatment in India. He utilizes cutting-edge technology, personalized treatment plans, and a multidisciplinary approach to ensure the best outcomes for eyelid cancer patients. His expertise in IMRT, IGRT, and breast-conserving therapies makes him one of India's leading oncologists."
    ],
    [
                    ...
                    <div class="mt-12">
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Targeted therapies and immunotherapy for specific eyelid cancer subtypes, including advanced treatments for metastatic eyelid cancer.
                                </p>
                            </div>
                ...
                <div class="container mx-auto px-4">
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <ul class="space-y-4">
                                {[
                                    "Best eyelid cancer treatment doctor in India with 34+ years experience",
