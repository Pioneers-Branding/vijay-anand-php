...
<head>
    ...
    <title>Top Medical Oncology Treatment in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Consult Dr. Vijay Anand Reddy for advanced medical oncology in India. Get expert chemotherapy, immunotherapy, targeted therapy, and personalized cancer care plans.">
    <!-- Google Fonts -->
                ...
                <div class="container mx-auto px-4">
                    ...
                    <div class="grid md:grid-cols-2 gap-12 items-start">
                        ...
                        <div class="relative h-full min-h-[400px]">
                            <img
                                src="assets/vijay-snand-hero.webp"
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished <strong>Medical Oncologist</strong> with over 34 years of experience. As the Director of Apollo Cancer Centres, Hyderabad, he has been instrumental in establishing the most comprehensive facility for <strong>medical oncology in India</strong>.
                            </p>
