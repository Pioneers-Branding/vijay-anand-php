...
<head>
    ...
    <title>Thyroid Cancer Specialist Doctor in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Seeking a Thyroid Cancer Specialist Doctor in India? Consult Dr. Vijay Anand Reddy for advanced diagnosis, personalized treatment, and compassionate cancer care.">
    <!-- Google Fonts -->
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                ...
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Radio active Iodine, IMRT therapy</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                ...
                <div class="container mx-auto px-4">
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <ul class="space-y-4">
                                {[
                                    "Best thyroid cancer treatment doctor in India with 34+ years experience",
