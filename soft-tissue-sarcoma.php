...
<head>
    ...
    <title>Best Soft Tissue Sarcoma Treatment in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Seeking advanced Soft Tissue Sarcoma treatment in India? Consult Dr. Vijay Anand Reddy for expert diagnosis, personalized care, and comprehensive cancer management.">
    <!-- Google Fonts -->
...
$faqs = [
    ...
    [
        ...
        'answer' => "With over 34 years of experience in radiation oncology, Dr. Vijay Anand Reddy offers world-class soft tissue sarcoma treatment in India. He utilizes cutting-edge technology, personalized treatment plans, and a multidisciplinary approach to ensure the best outcomes for sarcoma patients. His expertise in limb-saving therapies makes him one of India's leading oncologists."
    ],
    [
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                ...
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">IMRT, IGRT, Proton</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                    ...
                    <div class="mt-12">
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Targeted therapies and immunotherapy for specific soft tissue sarcoma subtypes, including advanced treatments for metastatic soft tissue sarcoma.
                                </p>
                            </div>
                ...
                <div class="container mx-auto px-4">
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <ul class="space-y-4">
                                {[
                                    "Best soft tissue sarcoma treatment doctor in India with 34+ years experience",
