...
<head>
  ...
  <meta name="description"
    content="Seeking the Best Oncologist in Hyderabad, India? Dr. Vijay Anand Reddy offers advanced cancer diagnosis, personalized treatments, and compassionate care.">
  ...
  <style>
    ...
    .banner-inner {
      ...
      /* Exact aspect ratio of mobile portrait banners (390x506) */
    }

    @media (min-width: 768px) {
      .banner-inner {
        aspect-ratio: 12/5;
        /* Exact aspect ratio of desktop landscape banners (1920x800, 3840x1600) */
        min-height: 300px;
        max-height: 620px;
      }
    }
...
<body class="bg-white text-gray-800">
  ...
  <section id="banners" class="relative pt-[135px] sm:pt-[100px] bg-gray-50 overflow-hidden w-full">
    <div class="banner-wrapper">
      <div class="banner-inner group">
        <!-- Slide 1 -->
        <div
          class="banner-slide absolute inset-0 w-full h-full transition-opacity duration-700 ease-in-out opacity-100 z-10"
          data-index="0">
          <picture class="w-full h-full block">
            <source media="(min-width: 768px)" srcset="assets/banners/Var-padma-banner.webp">
            <img src="assets/banners/padma.webp" alt="Dr. Vijay Anand Reddy - Padma Shri 2026"
              class="w-full h-full object-cover ">
          </picture>
        </div>
        <!-- Slide 2 -->
        <div
          class="banner-slide absolute inset-0 w-full h-full transition-opacity duration-700 ease-in-out opacity-0 z-0"
          data-index="1">
          <picture class="w-full h-full block">
            <source media="(min-width: 768px)" srcset="assets\banners\3-banner-img-1.webp">
            <img src="assets\banners\VAR-75-mobile.webp" alt="Dr. Vijay Anand Reddy - National Honour"
              class="w-full h-full object-cover ">
          </picture>
        </div>
        <!-- Slide 3 -->
        <div
          ...
          <picture class="w-full h-full block">
            ...
            <img src="assets/banners/image.webp" alt="Dr. Vijay Anand Reddy - Patient Testimony"
              class="w-full h-full object-cover ">
          </picture>
        </div>
        <!-- Slide 4 -->
        <div
          ...
          <picture class="w-full h-full block">
            ...
            <img src="assets/banners/good.webp" alt="Dr. Vijay Anand Reddy - Google Reviews"
              class="w-full h-full object-cover">
          </picture>
        </div>
        ...
        <button onclick="prevSlide()"
          class="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 z-20 bg-white/40 hover:bg-white/70 border border-white/20 backdrop-blur-md text-gray-800 rounded-full w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 opacity-0 sm:opacity-100 group-hover:opacity-100">
          <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
            <polyline points="15 18 9 12 15 6"></polyline>
          </svg>
        </button>
        <button onclick="nextSlide()"
          class="absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 z-20 bg-white/40 hover:bg-white/70 border border-white/20 backdrop-blur-md text-gray-800 rounded-full w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 opacity-0 sm:opacity-100 group-hover:opacity-100">
          <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
        ...
        <div class="absolute bottom-3 sm:bottom-4 left-1/2 -translate-x-1/2 z-20 flex gap-2 sm:gap-3">
          <button onclick="goToSlide(0)"
            class="banner-dot h-2 w-5 sm:h-2.5 sm:w-6 rounded-full bg-medical-blue transition-all duration-300 cursor-pointer"></button>
          <button onclick="goToSlide(1)"
            class="banner-dot h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-white/60 hover:bg-white transition-all duration-300 cursor-pointer"></button>
  ...
  <section id="about" class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16 reveal">
        <h2 class="text-4xl md:text-5xl font-bold text-medical-dark mb-6">Dr. Vijay Anand Reddy</h2>
        <p class="text-xl text-gray-600 max-w-3xl mx-auto"><b>Sr. Consultant Oncologist, Professor & Head, Dept. of
            Radiation Oncology</b></p><br>
        <p class="text-xl text-gray-600 max-w-3xl mx-auto">
          A distinguished oncologist with over three decades of experience, dedicated to providing world-class cancer
          care.
        </p>
      </div>
      ...
      <div class="grid lg:grid-cols-2 gap-16 items-stretch">
        ...
        <div class="relative h-full reveal">
          <img src="assets/vijay-anand-about.webp" alt="Dr. Vijay Anand Reddy"
            class="w-full h-full rounded-2xl shadow-2xl object-cover">
          <div
            class="hidden md:block absolute bottom-2 left-6 right-6 bg-white/95 backdrop-blur-sm p-6 rounded-xl shadow-lg">
        ...
        <div class="space-y-8 reveal delay-200">
          <div>
            ...
            <div class="space-y-3">
              ...
              $quals = [
                ...
                "Fellowships in FUICC (UK), FNDM (USA), FUICC (AUS)",
                "Trained in Reputed Cancer Institutes in Tata Memorial Hospital Mumbai & Adyar Cancer Institute Chennai",
                "Trained in Reputed Cancer Institutes in USA, UK, Australia & Germany"
              ];
              foreach ($quals as $q): ?>
                <div class="flex items-center space-x-3">
          ...
          <div class="bg-gradient-to-r from-medical-blue to-medical-purple p-6 rounded-xl text-white">
            ...
            <p class="leading-relaxed">"To provide world-class cancer care with cutting-edge technology, personalized
              treatment plans, and unwavering compassion..."</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="services" class="py-16 medical-gradient">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8">
        <div
          class="flex md:contents gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-4 md:pb-0 -mx-4 pl-4 pr-8 md:mx-0 md:px-0">
          <?php foreach ($services as $index => $service): ?>
            <div
              class="bg-white rounded-2xl shadow-lg card-hover group overflow-hidden min-w-[80vw] md:min-w-0 snap-start reveal delay-<?= $index * 100 ?>">
              ...
              <div class="p-6">
                ...
                <a href="<?= $service['link'] ?>"
                  class="text-medical-blue font-semibold hover:text-medical-purple transition-colors duration-200 inline-block">
                  Learn More →
                </a>
              </div>
            </div>
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center mt-8">
        <a href="specialties.php"
          class="inline-block bg-medical-blue text-white px-8 py-4 rounded-lg transition-all duration-200 font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-center">
      ...
      <div class="md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8 mb-16">
        <div
          ...
          <?php foreach ($reasons as $index => $reason): ?>
            <div
              class="bg-medical-light p-8 rounded-2xl card-hover group text-center min-w-[80vw] md:min-w-0 snap-start reveal delay-<?= $index * 100 ?>">
              <div class="relative mb-6">
                <div
                  class="w-20 h-20 bg-medical-blue/10 rounded-2xl flex items-center justify-center mx-auto group-hover:bg-medical-blue transition-all duration-300">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-lg max-w-4xl mx-auto border border-gray-100">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:+919676720002"
              class="inline-block border-2 border-medical-blue text-medical-blue px-8 py-4 rounded-lg hover:bg-medical-blue hover:text-white transition-all duration-200 font-semibold text-lg text-center">
              Call +91-9676720002
            </a>
          </div>
        </div>
  ...
  <section id="awards" class="py-16 medical-gradient">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div class="p-6">
                <div class="flex items-center justify-between mb-3">
                  ...
                  <div class="flex text-yellow-400">
                    <?php for ($i = 0; $i < 5; $i++): ?><i data-feather="star"
      ...
      <div class="text-center mb-16 reveal">
        <a href="/awards.php"
          class="inline-block px-6 py-2 border border-medical-blue text-medical-blue rounded-full font-semibold hover:bg-medical-blue hover:text-white transition-all duration-200">
          View More
        </a>
      </div>
      ...
      <div class="bg-white p-8 md:p-12 rounded-2xl shadow-lg reveal">
        <div class="text-center mb-12">
          ...
          <p class="text-gray-600 text-lg">Global recognition through prestigious international medical training
            programs</p>
        </div>
        <div class="md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-6">
          <div
            ...
            <?php foreach ($certifications as $cert): ?>
              <div
                class="bg-gray-50 border rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-all duration-200 group min-w-[80vw] md:min-w-0 snap-start">
      ...
      <div class="bg-white p-8 mt-10 md:p-12 rounded-2xl shadow-lg reveal">
        <div class="text-center mb-12">
          ...
          <p class="text-gray-600 text-lg">Active affiliations with leading international oncology societies and
            committees</p>
        </div>
        <div class="md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-6">
          <div
            ...
            <?php foreach ($memberships as $member): ?>
              <div
                class="flex items-start space-x-4 p-4 bg-medical-light rounded-xl hover:bg-medical-blue/5 transition-all duration-200 min-w-[80vw] md:min-w-0 snap-start">
        ...
        <div class="mt-10 text-center">
          <a href="/professional-association.php"
            class="inline-block px-6 py-2 border border-medical-blue text-medical-blue rounded-full font-semibold hover:bg-medical-blue hover:text-white transition-all duration-200">
            View More
          </a>
        </div>
  ...
  <section id="highest-rated" class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16 reveal">
        <div
          class="inline-flex items-center bg-yellow-100 text-yellow-800 px-4 py-2 rounded-full text-sm font-semibold mb-6">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
        <?php foreach ($googleStats as $index => $stat): ?>
          <div
            class="text-center p-8 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl border border-yellow-200 hover:shadow-lg transition-shadow duration-300 reveal delay-<?= $index * 100 ?>">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        <?php foreach ($patientGallery as $index => $p): ?>
          <div
            class="relative cursor-pointer overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow duration-200 reveal delay-<?= $index * 50 ?>">
            <img src="<?= $p['image'] ?>" alt="Patient testimonial <?= $index + 1 ?>"
              class="w-full h-48 object-cover object-center transform transition-transform duration-200 ease-in-out hover:scale-110"
              loading="lazy">
            <div
              class="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-200">
            </div>
          </div>
        <?php endforeach; ?>
      </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        <?php foreach ($recentEvents as $index => $event): ?>
          <div
            class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col overflow-hidden reveal delay-<?= $index * 100 ?> cursor-pointer group"
            ...
            <div class="h-56 w-full relative overflow-hidden">
              <?php if (!empty($event['banners'])): ?>
                <img src="<?= htmlspecialchars($event['banners'][0]) ?>" alt="<?= htmlspecialchars($event['title']) ?>"
                  class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
              <?php else: ?>
                <div
                  class="w-full h-full bg-gradient-to-br from-medical-blue to-blue-700 flex items-center justify-center p-6 text-center">
                  <h3 class="text-white text-2xl font-bold"><?= htmlspecialchars($event['title']) ?></h3>
                </div>
              <?php endif; ?>
              <div
                class="absolute top-4 left-4 bg-white/90 backdrop-blur text-medical-dark px-3 py-1.5 rounded-lg text-sm font-bold shadow-md">
            ...
            <div class="p-6 md:p-8 flex flex-col flex-grow">
              ...
              <h3
                class="font-bold text-xl md:text-2xl mb-4 text-medical-dark line-clamp-2 group-hover:text-medical-blue transition-colors">
              ...
              <div class="mt-auto pt-4 border-t border-gray-100 flex justify-between items-center">
                <span
                  class="inline-flex items-center text-medical-blue font-bold group-hover:text-medical-purple transition-colors">
                  Read More
      ...
      <div class="text-center reveal">
        <a href="events.php"
          class="inline-flex items-center bg-medical-blue text-white px-8 py-4 rounded-xl font-bold hover:bg-medical-dark transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="blog-posts-container"
          ...
          <?php foreach ($homepagePosts as $index => $post):
            ...
            <div class="group min-w-[80vw] md:min-w-0 snap-start reveal delay-<?= $index * 100 ?>">
              <a href="blog-post.php?id=<?= $post['id'] ?>&slug=<?= urlencode($slug) ?>"
                class="block bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
                <!-- Image Container -->
                <div class="relative h-56 sm:h-64 overflow-hidden">
                  <img src="<?= htmlspecialchars($postImage) ?>" alt="<?= htmlspecialchars($post['title']) ?>"
                ...
                <div class="bg-white p-5 sm:p-6">
                  ...
                  <h4
                    class="text-lg sm:text-xl font-bold text-gray-800 mb-2 line-clamp-2 group-hover:text-medical-blue transition-colors duration-200">
      ...
      <div class="text-center mt-12 reveal">
        <a href="blog-listing.php"
          class="inline-flex items-center px-8 py-4 bg-medical-blue text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
      ...
      <div class="grid lg:grid-cols-2 gap-6 sm:gap-12">
        ...
        <div class="space-y-3 sm:space-y-6 reveal">
          <div class="flex items-center sm:space-x-4 p-4 sm:p-6 bg-slate-50 rounded-xl">
            <div
              class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-full flex items-center justify-center text-medical-blue flex-shrink-0">
              <i data-feather="phone" class="w-5 h-5 sm:w-6 sm:h-6"></i>
            </div>
            <div>
          ...
          <div class="flex items-center sm:space-x-4 p-4 sm:p-6 bg-slate-50 rounded-xl">
            <div
              class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-full flex items-center justify-center text-medical-blue flex-shrink-0">
              <i data-feather="mail" class="w-5 h-5 sm:w-6 sm:h-6"></i>
            </div>
            <div class="min-w-0">
          ...
          <div class="flex items-center sm:space-x-4 p-4 sm:p-6 bg-slate-50 rounded-xl">
            <div
              class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-full flex items-center justify-center text-medical-blue flex-shrink-0">
              <i data-feather="map-pin" class="w-5 h-5 sm:w-6 sm:h-6"></i>
            </div>
            <div>
        ...
        <!-- Form -->
        <form accept-charset="UTF-8" action="https://app.formester.com/forms/DNnLlSMbe/submissions" method="POST"
          class="space-y-3 sm:space-y-4 bg-white p-4 sm:p-8 rounded-2xl shadow-xl border border-gray-100 reveal delay-200">
          <input type="hidden" name="_redirect" value="thankyou.php">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <input type="text" name="name" placeholder="Full Name" required
              class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-medical-blue outline-none text-sm sm:text-base">
            <input type="email" name="email" placeholder="Email" required
              class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-medical-blue outline-none text-sm sm:text-base">
          </div>
          <input type="tel" name="phone" placeholder="Phone Number" required
            class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-medical-blue outline-none text-sm sm:text-base">
          <textarea rows="3" name="message" placeholder="Message" required
            class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-medical-blue outline-none text-sm sm:text-base"></textarea>
          <button type="submit"
            class="w-full bg-medical-blue text-white p-3 sm:p-4 rounded-lg font-bold hover:bg-blue-700 transition text-sm sm:text-base">Send
            Message</button>
        </form>
      </div>
    </div>
