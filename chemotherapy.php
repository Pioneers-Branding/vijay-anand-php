...
<head>
    ...
    <title>Chemotherapy Treatment in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Seeking advanced Chemotherapy treatment in India? Consult Dr. Vijay Anand Reddy for personalized cancer care, modern treatment protocols & oncology support.">
    <!-- Google Fonts -->
...
$faqs = [
    [
        ...
        'answer' => "Dr. Vijay Anand Reddy is widely recognized as one of the best chemotherapy doctors in India, with over 34 years of experience in medical oncology. His expertise in advanced chemotherapy protocols, personalized treatment plans, and compassionate patient care makes him the preferred choice for cancer patients across India and internationally."
    ],
    [
...
<?php
$whyChoose = [
    "Best chemotherapy doctor in India with 34+ years experience",
                    ...
                    <div class="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            ...
                            <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                                Seeking world-class <strong>chemotherapy treatment in India</strong>? Dr. Vijay Anand Reddy offers advanced chemotherapy protocols, personalized care plans, and comprehensive oncology support at Apollo Cancer Centres Hyderabad with 34+ years of expertise.
                            </p>
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished oncologist with over 34 years of experience in providing world-class cancer care. As the Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced chemotherapy protocols and multimodal cancer treatment approaches in India.
                            </p>
