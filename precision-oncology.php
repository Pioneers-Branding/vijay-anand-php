...
$faqs = [
    ...
    [
        ...
        'answer' => "Dr. Vijay Anand Reddy is recognized as one of the best precision oncology doctors in India, with over 34 years of experience in medical oncology. His expertise in checkpoint inhibitors, CAR-T cell therapy, and personalized precision oncology protocols makes him the preferred choice for cancer precision oncology treatment."
    ],
    [
...
<?php
$whyChoose = [
    "Best precision oncology doctor in India with 34+ years experience",
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished oncologist with over 34 years of experience in providing world-class cancer care. As the Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced precision oncology protocols and personalized cancer treatment approaches in India.
                            </p>
