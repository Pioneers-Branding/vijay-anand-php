...
<head>
    ...
    <meta name="description" content="Seeking a trusted Breast Cancer Doctor in India? Consult Dr. Vijay Anand Reddy for advanced diagnosis, personalized treatment, and compassionate cancer care.">
    <!-- Google Fonts -->
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                ...
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">IMRT, IGRT, Hypo Fractionated, Ultra Hypo Fractionated, DIBH</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                    ...
                    <div class="mt-12">
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    IMRT, IGRT, Hypo & Ultrahypofractionation, and Accelerated Partial Breast Irradiation with real-time imaging for maximum precision and minimal side effects.
                                </p>
                            </div>
