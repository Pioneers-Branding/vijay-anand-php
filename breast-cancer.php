...
<head>
    ...
    <title>Breast Cancer Doctor in India | Dr. Vijay Anand Reddy</title>
    <meta name="description"
        content="Seeking a trusted Breast Cancer Doctor in India? Consult Dr. Vijay Anand Reddy for advanced diagnosis, personalized treatment, and compassionate cancer care.">
    <!-- Google Fonts -->
...
<body class="bg-gray-50">
    ...
    $faqs = [
        ...
        [
            ...
            'answer' => "With over 34 years of experience in radiation oncology, Dr. Vijay Anand Reddy offers world-class breast cancer treatment in India. He utilizes cutting-edge technology, personalized treatment plans, and a multidisciplinary approach to ensure the best outcomes for breast cancer patients. His expertise in IMRT, IGRT, and breast-conserving therapies makes him one of India's leading oncologists."
        ],
        [
    ...
    $stats = [
        ...
        ['label' => "Happy Patients", 'value' => "75k+", 'icon' => "FiUserCheck"],
    ...
    <div class="min-h-screen bg-white font-sans text-gray-800">
        ...
        <section class="relative pt-28 pb-16 lg:pt-40 lg:pb-24 overflow-hidden">
            <div class="absolute inset-0 z-0">
                <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=2080&auto=format&fit=crop"
                    alt="Medical Background" class="w-full h-full object-cover opacity-60" />
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="flex flex-col lg:flex-row items-center mt-10 gap-12">
                    <div class="lg:w-1/2 text-center lg:text-left">
                        <span
                            class="inline-block py-1 px-3 rounded-full bg-medical-blue/10 text-medical-blue text-sm font-semibold mb-4">
                        ...
                        <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                            Seeking world-class <strong>breast cancer treatment in India</strong>? Dr. Vijay Anand Reddy
                            offers advanced radiation oncology, precision surgery, and comprehensive cancer care at
                            Apollo Cancer Centres Hyderabad. Get expert treatment with the latest IMRT, IGRT, and
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="#book-appointment"
                                class="px-8 py-4 bg-medical-blue text-white rounded-lg font-semibold hover:bg-medical-dark transition shadow-lg flex items-center justify-center gap-2">
                                <i class="far fa-calendar-alt"></i> Book Appointment
                            </a>
                            <a href="tel:+919676720002"
                                class="px-8 py-4 bg-white text-medical-blue border border-medical-blue/30 rounded-lg font-semibold hover:bg-medical-light transition shadow-sm flex items-center justify-center gap-2">
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-center gap-8 text-center md:text-left">
                        ...
                        <div class="text-center">
                            <div class="text-4xl font-bold mb-1"
                                style="background: linear-gradient(to right, #9B528F, #8B5CF6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
                                85%</div>
                        ...
                        <!-- Divider -->
                        <div
                            class="hidden md:block w-px h-16 bg-gradient-to-b from-transparent via-gray-300 to-transparent">
                        </div>

                        <!-- Google Logo & Rating -->
                        <div whileInV class="flex items-center gap-4">
                        ...
                        <!-- Reviews Count -->
                        <div whileInV class="text-medical-dark">
                            <div
                                class="text-4xl font-bold mb-1 bg-gradient-to-r from-medical-blue to-medical-purple bg-clip-text text-transparent">
                                2,700+</div>
                        ...
                        <!-- CTA Button -->
                        <div whileInV>
                            <a href="https://www.google.com/maps?ll=17.414722,78.412148&z=12&t=m&hl=en-US&gl=US&mapclient=embed&cid=1736553121756056830"
                                target="_blank" rel="noopener noreferrer"
                                class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-medical-blue to-medical-purple text-white rounded-lg font-bold hover:shadow-xl transition-all shadow-lg">
                    ...
                    <?php foreach ($stats as $stat): ?>
                        <div class="text-center">
                            <div class="text-4xl mb-2 flex justify-center opacity-80">
                                ...
                                if (strpos($stat['icon'], 'FiClock') !== false)
                                    $iconClass = 'far fa-clock';
                                elseif (strpos($stat['icon'], 'FiActivity') !== false)
                                    $iconClass = 'fas fa-chart-line';
                                elseif (strpos($stat['icon'], 'FiUserCheck') !== false)
                                    $iconClass = 'fas fa-user-check';
                                elseif (strpos($stat['icon'], 'FiAward') !== false)
        ...
        <section class="py-16 bg-white">
            <div class="container mx-auto px-4">
                <div class="text-center max-w-3xl mx-auto mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Comprehensive Breast Cancer
                        Treatment in India</h2>
                    <p class="text-gray-600 text-lg">
                        Experience cutting-edge breast cancer treatment in India with advanced radiation oncology,
                        precision surgery, and personalized care. Dr. Vijay Anand Reddy offers the best outcomes with
                ...
                <div class="grid md:grid-cols-2 gap-12 items-start">
                    <div>
                        ...
                        <p class="text-gray-600 mb-6 leading-relaxed">
                            Breast cancer begins when cells in the breast grow out of control. Dr. Vijay Anand Reddy, a
                            leading specialist in <strong>breast cancer treatment in India</strong>, offers
                            comprehensive care including advanced diagnostics, minimally invasive surgery, precision
                            radiation therapy ( IMRT, IGRT, DIBH), chemotherapy, hormone therapy, and targeted therapy
                            tailored
                            to each patient's unique cancer type and stage.
                        </p>

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                            <div
                                class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                <div class="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1"><i
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">IMRT, IGRT, Hypo Fractionated, Ultra Hypo
                                        Fractionated, DIBH</p>
                                </div>
                            </div>
                            <div
                    ...
                    <div class="relative h-full min-h-[400px]">
                        <img src="assets/condiotion-images/breast-cancer-condition.webp"
                ...
                <div class="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                    ...
                    <p class="text-white text-lg mb-6 max-w-2xl mx-auto">
                        Get expert guidance on the best breast cancer treatment in India. Book a personalized
                        consultation to discuss your treatment options and customized care plan.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="#book-appointment"
                            class="px-8 py-4 bg-white text-medical-blue rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg flex items-center justify-center gap-2">
                            <i class="far fa-calendar-alt"></i> Book Consultation Now
                        </a>
                        <a href="tel:+919676720002"
                            class="px-8 py-4 bg-medical-dark text-white border-2 border-white rounded-lg font-semibold hover:bg-medical-purple transition flex items-center justify-center gap-2">
                            <i class="fas fa-phone-alt"></i> Call +91-9676720002
                        </a>
                    </div>
                </div>
        ...
        <section class="pb-16 bg-white">
            <div class="container mx-auto px-4">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div whileInV class="relative">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                            <img src="assets/vijay-anand-about.webp"
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                            Dr. Vijay Anand Reddy is a distinguished radiation oncologist with over 34 years of
                            experience providing world-class <strong>breast cancer treatment in India</strong>. As the
                            Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced radiation oncology
                            techniques and personalized treatment approaches for breast cancer patients.
                        </p>
                        <p class="text-gray-600 mb-8 leading-relaxed">
                            He is renowned for his expertise in IMRT, IGRT, and breast-conserving therapies. His
                            commitment to personalized patient care, use of cutting-edge technology, and evidence-based
                            medicine has earned him recognition as one of India's leading breast cancer specialists.
                        </p>

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-full bg-medical-blue/10 flex items-center justify-center text-medical-blue">
                        ...
                        <a href="/achievements"
                            class="inline-flex items-center gap-2 text-medical-blue font-semibold hover:gap-3 transition-all">
        ...
        <section class="py-14 bg-medical-light">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Our Breast Cancer Treatment
                        Process</h2>
                    <p class="text-gray-600 text-lg max-w-3xl mx-auto">
                        A systematic, patient-centric approach to breast cancer treatment in India. Dr. Vijay Anand
                        Reddy and his team follow a comprehensive 4-step process for optimal treatment outcomes.
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-4 gap-8">
                    ...
                    <?php foreach ($treatmentSteps as $item): ?>
                        <div
                            class="bg-white rounded-xl shadow-md hover:shadow-xl transition border-t-4 border-medical-blue relative overflow-hidden group">
                            <div class="relative h-40 overflow-hidden">
                                <img src="<?= $item['image'] ?>" alt="<?= $item['title'] ?>"
                                    class="w-full h-full object-cover group-hover:scale-110 transition duration-500" />
                                <div
                                    class="absolute top-3 right-3 bg-medical-blue text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg shadow-lg">
                                    <?= $item['step'] ?>
                                </div>
                            </div>
                            <div class="p-6">
                ...
                <div class="mt-12 text-center">
                    <div class="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-medical-blue max-w-4xl mx-auto">
                        ...
                        <p class="text-gray-600 mb-6 text-lg">
                            Don't wait to start your journey to recovery. Dr. Vijay Anand Reddy and our expert team are
                            ready to provide you with the best breast cancer treatment in India with world-class care.
                        </p>
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="#book-appointment"
                                class="px-8 py-4 bg-medical-blue text-white rounded-lg font-semibold hover:bg-medical-dark transition shadow-lg flex items-center justify-center gap-2">
                            ...
                            <a href="tel:+919676720002"
                                class="px-8 py-4 bg-white text-medical-blue border-2 border-medical-blue rounded-lg font-semibold hover:bg-medical-light transition flex items-center justify-center gap-2">
                                <i class="fas fa-phone-alt"></i> Call +91-9676720002
                            </a>
                        </div>
                    </div>
        ...
        <section class="py-16 bg-white">
            <div class="container mx-auto px-4">
                <div class="text-center max-w-3xl mx-auto mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Breast Cancer Treatment at Apollo
                        Cancer Centres India</h2>
                    <p class="text-gray-600 text-lg">
                        State-of-the-art breast cancer treatment infrastructure with world-class facilities, latest
                        technology, expert care, and the best breast cancer doctor in India - Dr. Vijay Anand Reddy.
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-12 mb-12">
                    <div>
                        ...
                        <p class="text-gray-600 mb-6 leading-relaxed">
                            Apollo Cancer Centres is equipped with India's most advanced breast cancer treatment
                            facilities, offering comprehensive cancer care with the latest diagnostic tools, minimally
                            invasive surgery, precision radiation therapy, and targeted treatments. Under the leadership
                            of Dr. Vijay Anand Reddy, our center provides world-class <strong>breast cancer treatment in
                                India</strong>.
                        </p>
                        <p class="text-gray-600 mb-6 leading-relaxed">
                            Our breast cancer program combines evidence-based medicine with a multidisciplinary team
                            approach, ensuring each patient receives personalized treatment plans tailored to their
                            specific cancer stage, type, and biomarker profile.
                        </p>
                        <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20">
                            ...
                            <ul class="space-y-2">
                                ...
                                <li class="flex items-start gap-2 text-gray-700 text-sm">
                                    <span class="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                                    Advanced radiation therapy (IMRT, IGRT, Hypo & Ultrahypofractionation, DIBH)
                                </li>
                                <li class="flex items-start gap-2 text-gray-700 text-sm">
                                    <span class="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                ...
                <div class="mt-12">
                    <h3 class="text-2xl font-bold text-medical-dark mb-8 text-center">Advanced Breast Cancer Treatment
                        Facilities & Equipment</h3>
                    <div class="grid md:grid-cols-3 gap-6">
                        <div
                            class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                            ...
                            <p class="text-gray-600 text-sm leading-relaxed">
                                3D digital mammography, breast MRI, molecular imaging, and comprehensive biomarker
                                testing for accurate diagnosis and treatment planning.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-gray-600 text-sm leading-relaxed">
                                Breast-conserving lumpectomy, sentinel lymph node biopsy, oncoplastic surgery, and
                        ...
                        <div
                            ...
                            <p class="text-gray-600 text-sm leading-relaxed">
                                IMRT, IGRT, Hypo & Ultrahypofractionation, and Accelerated Partial Breast Irradiation
                                with real-time imaging for maximum precision and minimal side effects.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-gray-600 text-sm leading-relaxed">
                                HER2-targeted therapies, hormone therapy, CDK4/6 inhibitors, and immunotherapy for
                        ...
                        <div
                            ...
                            <p class="text-gray-600 text-sm leading-relaxed">
                                BRCA1/2 testing, comprehensive genomic profiling, and personalized treatment selection
                        ...
                        <div
                            ...
                            <p class="text-gray-600 text-sm leading-relaxed">
                                Counseling, nutrition support, physiotherapy, lymphedema management, and survivorship
                                programs for complete well-being.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-14 bg-medical-light">
            <div class="container mx-auto px-4">
                <div class="flex flex-col lg:flex-row gap-16 items-center">
                    <div class="lg:w-1/2">
                        ...
                        <p class="text-gray-600 mb-8 text-lg">
                            As a pioneer in breast cancer treatment in India, Dr. Vijay Anand Reddy brings world-class
                            expertise in radiation oncology and comprehensive cancer care. His dedication to
                            evidence-based medicine and patient outcomes makes him the preferred choice for breast
                            cancer treatment.
                        </p>
                        <ul class="space-y-4">
                            {[
                            "Best breast cancer treatment doctor in India with 34+ years experience",
                    ...
                    <div class="lg:w-1/2 grid grid-cols-2 gap-4">
                        <div
                            class="bg-medical-blue/10 p-6 rounded-2xl text-center shadow-md hover:shadow-xl transition border border-medical-blue/20">
                            <div
                                class="bg-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 text-medical-blue text-2xl font-bold shadow-md">
                        ...
                        <div
                            class="bg-medical-blue/15 p-6 rounded-2xl text-center translate-y-8 shadow-md hover:shadow-xl transition border border-medical-blue/30">
                            <div
                                class="bg-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 text-medical-blue text-2xl font-bold shadow-md">
                                <i class="fas fa-chart-line"></i>
                            </div>
                        ...
                        <div
                            class="bg-medical-blue/20 p-6 rounded-2xl text-center shadow-md hover:shadow-xl transition border border-medical-blue/40">
                            <div
                                class="bg-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 text-medical-blue text-2xl font-bold shadow-md">
                        ...
                        <div
                            class="bg-medical-blue/25 p-6 rounded-2xl text-center translate-y-8 shadow-md hover:shadow-xl transition border border-medical-blue/50">
                            <div
                                class="bg-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 text-medical-blue text-2xl font-bold shadow-md">
                                <FiUsers size={28} />
                            </div>
                ...
                <div class="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                    ...
                    <p class="text-white text-lg mb-6 max-w-2xl mx-auto">
                        Join thousands of patients who have trusted Dr. Vijay Anand Reddy, the best breast cancer
                        treatment doctor in India, for advanced cancer treatment with proven results and compassionate
                        care.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <a href="#book-appointment"
                            class="px-8 py-4 bg-white text-medical-blue rounded-lg font-bold hover:bg-gray-100 transition shadow-lg flex items-center justify-center gap-2 text-lg">
                            <i class="far fa-calendar-alt"></i> Book Your Consultation
                        </a>
                        <a href="https://www.google.com/maps?ll=17.414722,78.412148&z=12&t=m&hl=en-US&gl=US&mapclient=embed&cid=1736553121756056830"
                            target="_blank" rel="noopener noreferrer"
                            class="px-8 py-4 bg-white text-medical-blue border-2 border-white rounded-lg font-semibold hover:bg-medical-light transition flex items-center justify-center gap-2">
        ...
        <section class="py-16 bg-white">
            <div class="container mx-auto px-4">
                <div class="text-center max-w-3xl mx-auto mb-12">
                    ...
                    <p class="text-gray-600 text-lg">
                        We provide comprehensive support for international patients seeking affordable and high-quality
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    ...
                    <?php foreach ($subServices as $service): ?>
                        <div
                            class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition group">
                            <div
                                class="bg-white w-14 h-14 rounded-full flex items-center justify-center text-medical-blue mb-4 shadow-sm group-hover:scale-110 transition">
                                <?php
                                $iconClass = 'fas fa-star';
                                if (strpos($service['icon'], 'FiMessageSquare') !== false)
                                    $iconClass = 'far fa-comments';
                                elseif (strpos($service['icon'], 'FiFileText') !== false)
                                    $iconClass = 'far fa-file-alt';
                                elseif (strpos($service['icon'], 'FiHome') !== false)
                                    $iconClass = 'fas fa-home';
                                elseif (strpos($service['icon'], 'FiGlobe') !== false)
                ...
                <div class="bg-medical-blue rounded-2xl p-8 md:p-12 relative overflow-hidden">
                    ...
                    <div class="absolute bottom-0 left-0 w-64 h-64 bg-white/10 rounded-full -ml-16 -mb-16 blur-2xl">
                    </div>
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div class="text-white max-w-xl">
                            ...
                            <p class="text-blue-100 text-lg mb-6">
                                Our dedicated International Patient Care team is available 24/7 to assist with treatment
                                planning, cost estimates, and travel arrangements for breast cancer treatment in India.
                            </p>
                        ...
                        <div class="flex flex-col gap-4 w-full md:w-auto">
                            <a href="https://wa.me/919676720002" target="_blank" rel="noopener noreferrer"
                                class="px-8 py-4 bg-white text-medical-blue rounded-lg font-bold hover:bg-gray-100 transition shadow-lg flex items-center justify-center gap-2">
                                <i class="far fa-comments"></i> Chat on WhatsApp
                            </a>
                            <a href="mailto:cancercare@drvijayanandreddy.com"
                                class="px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-bold hover:bg-white/10 transition flex items-center justify-center gap-2">
        ...
        <section class="py-18 mt-10 bg-white">
            <div class="container mx-auto px-4">
                <div class="text-center max-w-4xl mx-auto mb-12">
                    <div whileInV>
                        <span
                            class="inline-block py-2 px-4 rounded-full bg-medical-blue/10 text-medical-blue text-sm font-semibold mb-4">
                            ⭐ Patient Reviews & Ratings
                        </span>
                        <h2 class="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                            Most Reviewed & Highest Rated <span class="text-medical-blue">Breast Cancer Treatment Doctor
                                in India</span>
                        </h2>
                        <p class="text-gray-600 text-lg">
                            Dr. Vijay Anand Reddy has earned the trust of thousands of breast cancer patients through
                            exceptional care, advanced treatment techniques, and outstanding clinical outcomes.
                        </p>
                    </div>
                </div>
                ...
                <script defer src="https://dbwx2z9xa7qt9.cloudfront.net/bundle.js?cachebust=1780056397000" theme="light"
                    footer="false" widget-type="carousel" token="687a20a3a7ee08492b66abfc"
                    apiurl="https://server.onlinereviews.tech/api/v0.0.9" stats="true" addReview="true"
                    profile-pic="true" review-name="true" positive-stars="false" wl="true"
                    wlndig="https://go.meddyreviews.com/dr-vijay-anand-reddy" lang="us"
        ...
        <section class="py-16 bg-gray-50"
            x-data="{ currentVideo: <?php echo htmlspecialchars(json_encode($videos[0])); ?> }">
            <div class="container mx-auto px-4">
                <div class="text-center max-w-3xl mx-auto mb-12">
                    <span
                        class="inline-block py-1 px-3 rounded-full bg-medical-blue/10 text-medical-blue text-sm font-semibold mb-4">
                    ...
                    <p class="text-gray-600 text-lg">
                        Hear from our patients about their successful bone cancer treatment journey with Dr. Vijay Anand
                        Reddy.
                    </p>
                </div>
                ...
                <div class="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div class="relative aspect-video bg-black">
                        <iframe :src="'https://www.youtube.com/embed/' + currentVideo.id + '?rel=0'"
                            :title="currentVideo.title" class="w-full h-full"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div id="video-scroll-container"
                                ...
                                <?php foreach ($videos as $video): ?>
                                    <div @click="currentVideo = <?php echo htmlspecialchars(json_encode($video)); ?>"
        ...
        <section class="py-14">
            <div class="container mx-auto px-4">
                <div class="max-w-4xl mx-auto">
                    <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-8 text-center">Frequently Asked
                        Questions</h2>
                    <p class="text-gray-600 mb-6 text-center">
                        Get answers to common questions about breast cancer treatment, costs, success rates, and what to
                        expect from India's best breast cancer treatment doctor, Dr. Vijay Anand Reddy.
                    </p>
                    <div class="space-y-4">
    ...
    <script defer src="https://app.wacrs.com/install-widget/bundle.js?key=484b0ca7-463d-4440-80be-d5486f4218a8"
        id="wacrs-widget-script" data-active data-widget-type="group"
        data-person="87189a5a-e9a7-41af-b814-23d00163f7b8"></script>
