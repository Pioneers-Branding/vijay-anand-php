...
<head>
    ...
    <title>Retinoblastma Treatment in India | Dr. Vijay Anand Reddy</title>
    <meta name="description" content="Seeking advanced Retinoblastoma Treatment in India? Get expert, child-focused cancer care with modern therapies under the guidance of Dr. Vijay Anand Reddy.">
    <!-- Google Fonts -->
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                ...
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Plaque Brachytherapy, IMRT</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Personalized treatment, Intra Arterial chemotherapy</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                    ...
                    <div class="mt-12">
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Targeted therapies and immunotherapy for specific retinoblastoma subtypes, including advanced treatments for metastatic retinoblastoma.
                                </p>
                            </div>
