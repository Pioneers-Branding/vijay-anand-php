...
$faqs = [
    ...
    [
        ...
        'answer' => "Dr. Vijay Anand Reddy is recognized as one of the best supportive oncology care doctors in India, with over 34 years of experience in medical oncology. His expertise in checkpoint inhibitors, CAR-T cell therapy, and personalized supportive oncology care protocols makes him the preferred choice for cancer supportive oncology care treatment."
    ],
    [
...
<?php
$whyChoose = [
    "Best supportive oncology care doctor in India with 34+ years experience",
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished oncologist with over 34 years of experience in providing world-class cancer care. As the Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced supportive oncology care protocols and personalized cancer treatment approaches in India.
                            </p>
