...
$faqs = [
    ...
    [
        ...
        'answer' => "With over 34 years of experience, Dr. Vijay Anand Reddy is a leading expert in head and neck oncology. He utilizes cutting-edge technology like IMRT and IGRT to deliver precise radiation, minimizing side effects and preserving vital functions like speech and swallowing."
    ],
    [
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished radiation oncologist with over 34 years of experience providing world-class <strong>head and neck cancer treatment in India</strong>. As the Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced radiation oncology techniques.
                            </p>
                ...
                <div class="container mx-auto px-4">
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <ul class="space-y-4">
                                {[
                                    "Expert head & neck oncologist with 34+ years experience",
